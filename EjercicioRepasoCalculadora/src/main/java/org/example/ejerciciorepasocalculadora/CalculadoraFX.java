...
// Desarrollar una aplicación de JavaFX que funcione como una calculadora simple, permitiendo realizar operaciones básicas (suma, resta, multiplicación y división) entre dos números ingresados por el usuario.
